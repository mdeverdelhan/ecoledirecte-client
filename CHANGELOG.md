...
- Mise à jour de la version du site en 4.100.4
...
- Suppression des spécialisations de `EcoleDirecteApiResponse`
- Duplication des méthodes du client pour accès à la réponse complète de l'API
